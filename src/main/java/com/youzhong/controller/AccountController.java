...
public class AccountController {
	...
	@RequestMapping("accountListByWeixinId/{id}")
	@ResponseBody
	public List<Account> accountjsonListByWeixinId(@PathVariable int id) {
		return accountService.findByWeixinId(id);
	}
	
	@RequestMapping("gameroleListByAccountId/{id}")
	@ResponseBody
	public List<GameRole> gameroleListByAccountId(@PathVariable int id){
		return gameRoleService.findByAccountId(id);
	}
